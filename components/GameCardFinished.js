...
export default function GameCardFinished({data}){  
    ...
    return (
        <div className="md:p-2 pr-2 flex divide-y-1 w-full md:rounded-md divide-solid divide-white mt-2 border-b justify-between items-center md:w-2/5 md:mb-8 md:bg-black">
